...
TEXTS: dict[str, dict[str, str]] = {
    ...
    "start_registered_intro": {
        "ru": "Здравствуйте, {name}!\n\nВыберите язык интерфейса или откройте профиль.",
        "ky": "Саламатсызбы, {name}!\n\nИнтерфейс тилин тандаңыз же профилди ачыңыз.",
    },
    "language_changed": {
        "ru": "Язык бота обновлён: {language}",
        "ky": "Боттун тили жаңыртылды: {language}",
    },
    "language_choose": {
