    ...
    return (
        <>
                        ...
                        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-5 sm:gap-6">
                            ...
                            <div className="space-y-1.5 w-full">
                                ...
                                <EmployeeActivityBadge
                                    ...
                                    compact
                                    className="!mt-3 p-0 border-none bg-transparent"
                                />
                            </div>
                        </div>
                    </DialogHeader>
            ...
            {isPhotoOpen && photoTelegramId && (
                ...
                >
                    <button
                        className="absolute top-4 right-4 sm:top-8 sm:right-8 text-white/70 hover:text-white transition-colors bg-white/10 hover:bg-white/20 rounded-full p-2 backdrop-blur-md z-10"
                    ...
                    <img
                        ...
                        onError={(e) => {
                            ...
                            (e.currentTarget as HTMLImageElement).className = "max-w-full max-h-[80vh] object-contain";
                        }}
                    />
                </div>
            )}
