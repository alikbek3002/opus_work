...
const tariffAnnouncements = [
    'Успей купить тариф Стандарт со скидкой 50% до конца недели',
    'Премиум на месяц: +30 открытий сотрудников в подарок',
    'Базовый тариф: первые 7 дней по спеццене для новых работодателей',
    'Продли подписку заранее и получи бонусные открытия без доплаты',
    'Горячая акция: скидка на тарифы при оплате до 23:59 сегодня',
];
